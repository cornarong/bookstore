...
public class CrawlingService {
    ...
    public void crawling(String uid, String type) throws IOException {
        ...
        if(type.equals("korea")){
            url = "http://www.kyobobook.co.kr/bestSellerNew/bestseller.laf?mallGb=KOR&range=0&kind=0&linkClass=0";
            bookType = BookType.DOMESTIC;
        /* 교보문고 국외도서 */
        }else if(type.equals("foreign")){
            url = "http://www.kyobobook.co.kr/bestSellerNew/bestseller.laf?mallGb=ENG&range=0&kind=0&linkClass=A";
